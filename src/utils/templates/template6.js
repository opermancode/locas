...
body{font-family:Arial,sans-serif;font-size:11px;color:#111;position:relative}
.page{padding:26px 28px;position:relative;overflow:hidden}
.corner{position:absolute;top:0;right:0;width:0;height:0;border-style:solid;border-width:0 80px 80px 0;border-color:transparent ${accentColor} transparent transparent}
.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:18px;padding-bottom:14px;border-bottom:2.5px solid ${accentColor}}
.biz-name{font-size:20px;font-weight:900;color:#111;margin-bottom:4px}
.biz-detail{font-size:10px;color:#555;line-height:1.8}
.gstin-tag{display:inline-block;background:${accentColor}15;color:${accentColor};font-size:9px;font-weight:700;padding:2px 8px;border-radius:3px;margin-top:4px;border:1px solid ${accentColor}33}
.inv-block{text-align:right}
.inv-label{font-size:30px;font-weight:900;color:${accentColor};letter-spacing:3px}
.inv-badge{display:inline-block;background:${accentColor};color:#fff;font-size:10px;font-weight:700;padding:3px 12px;border-radius:3px;margin-top:4px;letter-spacing:.5px}
...
.meta-bar{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid ${accentColor}22;margin-bottom:14px;overflow:hidden;border-radius:4px}
.meta-cell{padding:7px 10px;border-right:1px solid ${accentColor}18}
...
.pcol{flex:1;border:1px solid ${accentColor}22;border-radius:4px;overflow:hidden}
...
.stag{display:inline-block;background:${accentColor}12;color:${accentColor};font-size:9px;font-weight:700;padding:2px 8px;border-radius:3px;margin-top:5px;border:1px solid ${accentColor}30}
table{width:100%;border-collapse:collapse;margin-bottom:12px;border:1px solid ${accentColor}15}
thead tr{background:${accentColor};color:#fff}
th{padding:8px 7px;font-size:10px;font-weight:700;text-align:left}
.tc{text-align:center}.tr{text-align:right}.tl{text-align:left}
td{padding:8px 7px;font-size:10px;border-bottom:1px solid ${accentColor}10;vertical-align:middle}
.sm{font-size:9px;color:#9CA3AF}.bold{font-weight:700}
.bottom{display:flex;gap:12px;margin-bottom:14px}
.left-col{flex:1}
.words{background:${accentColor}06;border:1px solid ${accentColor}22;padding:8px 10px;border-radius:4px;margin-bottom:8px}
...
.tc-box{background:#F9FAFB;border:1px solid #E5E7EB;padding:8px 10px;border-radius:4px;margin-bottom:8px}
.tc-title{font-size:9px;font-weight:700;color:#374151;text-transform:uppercase;margin-bottom:4px}
.tc-body{font-size:10px;color:#555;line-height:1.7}
.upi{border:1px solid ${accentColor}22;padding:8px;text-align:center;border-radius:4px}
.upi-label{font-size:9px;font-weight:700;color:${accentColor};margin-bottom:4px}
.upi-box{width:56px;height:56px;border:1.5px dashed ${accentColor}55;background:#f9f9f9;margin:0 auto;display:flex;align-items:center;justify-content:center;font-size:8px;color:#999;text-align:center;border-radius:4px;line-height:1.4}
...
.trow{display:flex;justify-content:space-between;padding:6px 10px;font-size:11px;border-bottom:1px solid ${accentColor}10}
.trow-muted{color:#666}
.trow-danger{color:#DC2626;font-weight:700}
.trow-grand{display:flex;justify-content:space-between;padding:10px;font-size:15px;font-weight:900;background:${accentColor};color:#fff}
.bank-box{border:1px solid ${accentColor}18;padding:8px 10px;margin-bottom:8px;border-radius:4px;font-size:10px;background:${accentColor}05}
...
.sh{background:${accentColor}10;padding:6px 10px;font-size:9px;font-weight:700;color:${accentColor};text-transform:uppercase;border-bottom:1px solid ${accentColor}18}
