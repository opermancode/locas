  ...
  const A4_PRINT_CSS = `
    ...
    @media screen {
      ...
      .page { width:210mm; min- box-shadow:0 4px 24px rgba(0,0,0,0.13); background:#fff; }
    }
  `;
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .bottom-section td { vertical-align: top; padding: 0; }
    .bottom-left { padding: 18px 24px; border-right: 1px solid #ddd; }
