  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    66;display:flex;align-items:center;justify-content:center;font-size:7pt;color:${accent};text-align:center;font-weight:700;margin:0 auto}
    ...
    <div class="bot">
      ...
      <div class="tright">
        ...
        <div class="sign">
          ...
          <div class="sb"><div class="sline">Authorised Signatory</div></div>
        </div>
      </div>
    </div>
  </div>
