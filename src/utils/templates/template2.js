...
export default function template2(invoice, profile, accent='#0F766E', upiBlock='') {
  ...
  const rows=(inv.items||[]).map((item,i)=>`
    <tr style="background:${i%2===0?accent+'0D':'#fff'}">
      <td class="tc">${i+1}</td>
...
.hband{background:${accent};padding:20px 26px;display:flex;justify-content:space-between;align-items:flex-end}
.bn{font-size:20px;font-weight:900;color:#fff;margin-bottom:3px}
.bd{font-size:10px;color:rgba(255,255,255,.8);line-height:1.8}
.il{font-size:32px;font-weight:900;color:#fff;letter-spacing:4px;opacity:.95}
.im{text-align:right;font-size:10px;color:rgba(255,255,255,.8);margin-top:4px;line-height:1.8}
...
.mbar{display:flex;border:1.5px solid ${accent}33;margin-bottom:12px;border-radius:4px;overflow:hidden}
.mc{flex:1;padding:6px 10px;border-right:1px solid ${accent}22}.mc:last-child{border-right:none}.mc:nth-child(odd){background:${accent}06}
...
.pc{flex:1;border:1px solid ${accent}33;border-radius:4px;overflow:hidden}
...
.tcbox{background:${accent}06;border-left:3px solid ${accent};padding:7px 10px;margin-bottom:6px;font-size:10px;color:#444;line-height:1.7}
.tright{width:238px}
...
.tgrand{display:flex;justify-content:space-between;padding:9px 10px;font-size:14px;font-weight:900;background:${accent};color:#fff;border-radius:0 0 4px 4px}
.bank{border:1px solid ${accent}22;padding:8px 10px;margin-top:6px;background:${accent}06;border-radius:3px;font-size:10px}
.blab{font-size:9px;font-weight:700;color:${accent};text-transform:uppercase;margin-bottom:3px}
.sign{border:1px solid ${accent}22;margin-top:6px;border-radius:4px;overflow:hidden}
