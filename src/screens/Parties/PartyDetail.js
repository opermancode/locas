...
const styles = StyleSheet.create({
  ...
  avatarBox:      { width: 56, height: 56, borderRadius: RADIUS.full, backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  infoCard:       { backgroundColor: COLORS.card, marginHorizontal: 16, marginTop: 16, borderRadius: RADIUS.lg, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden' },
  balanceRow:     { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 14, backgroundColor: COLORS.primaryLight },
  balanceLabel:   { fontSize: 13, color: COLORS.primary, fontWeight: FONTS.semibold },
  balanceValue:   { fontSize: 18, fontWeight: FONTS.black, color: COLORS.primary },
  invCard:        { backgroundColor: COLORS.card, marginHorizontal: 16, marginBottom: 10, borderRadius: RADIUS.lg, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden' },
  invCardTop:     { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', padding: 14 },
  newInvBtn:      { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: COLORS.primary, paddingHorizontal: 16, paddingVertical: 10, borderRadius: RADIUS.md, margin: 16 },
  newInvBtnText:  { color: '#fff', fontWeight: FONTS.bold, fontSize: 13 },
  emptyText:      { fontSize: 14, color: COLORS.textMute, textAlign: 'center', marginTop: 40, marginBottom: 20 },
