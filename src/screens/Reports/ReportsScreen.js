...
const styles = StyleSheet.create({
  ...
  plCard:     { backgroundColor: COLORS.secondary, borderRadius: RADIUS.xl, padding: 20, marginHorizontal: 16, marginTop: 16, marginBottom: 8 },
  ...
  gstRow:     { flexDirection: 'row', gap: 10, marginBottom: 2, marginHorizontal: 16 },
  ...
  statRow:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 11, paddingHorizontal: 16, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  ...
  gstCard:       { backgroundColor: COLORS.card, borderRadius: RADIUS.lg, borderWidth: 1, borderColor: COLORS.border, overflow: 'hidden', marginHorizontal: 16, marginBottom: 2 },
  ...
  exportHint:    { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: COLORS.infoLight, borderRadius: RADIUS.lg, padding: 16, marginHorizontal: 16, marginTop: 16 },
