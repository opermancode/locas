...
function AreaChart({ data = [] }) {
  ...
  const W=420, H=84, PL=0, PR=0, PT=6, PB=20;
...
const s = StyleSheet.create({
  ...
  qaTitle: { fontSize:9, fontWeight:'700', color:'rgba(255,255,255,0.3)', textTransform:'uppercase', letterSpacing:1, marginBottom:8 },
  qaRow:   { flexDirection:'row', flexWrap:'wrap', gap:5 },
  qaItem:  { width:'23%', alignItems:'center', gap:4 },
  ...
  qaLabel: { fontSize:8, color:'rgba(255,255,255,0.4)', textAlign:'center', fontWeight:'500' },
  ...
  donutTitle: { fontSize:9, fontWeight:'700', color:'rgba(255,255,255,0.3)', textTransform:'uppercase', letterSpacing:1, marginBottom:8 },
